    ...
    <table id="myTable" class="table">
        ...
        <thead>
            <tr>
                ...
                <td style='cursor: pointer;'>Nedosptupná </td>                
        ...
        <tbody>
            <?php 
        //foreach($results as $row){ // GET SADU BODY, // NOT DONE RADIO DOEWSNT WORK
            //get id of sada
            echo '<tr>
            <td>xyz</td>
            <td><input type="radio" id="on" name="on"></td> 
            <td><input type="radio" id="off" name="off"></td>
